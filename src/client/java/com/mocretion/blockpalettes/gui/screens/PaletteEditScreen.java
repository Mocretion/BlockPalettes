...
public class PaletteEditScreen extends AbstractContainerScreen<EditMenu> implements MenuAccess<EditMenu> {
    private static final Identifier BG_TEXTURE = Identifier.fromNamespaceAndPath(BlockPalettesClient.MOD_ID, "textures/gui/palette_view.png");
    private static final Identifier ADD_WEIGHT_TEXTURE = Identifier.fromNamespaceAndPath(BlockPalettesClient.MOD_ID, "textures/gui/add_row.png");
    private static final Identifier INVENTORY_ROW_TEXTURE = Identifier.fromNamespaceAndPath(BlockPalettesClient.MOD_ID, "textures/gui/inventory_row.png");
    private static final Identifier TEXT_ROW_TEXTURE = Identifier.fromNamespaceAndPath(BlockPalettesClient.MOD_ID, "textures/gui/text_row.png");
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        if(isPointInRegion(leftPos + titleInputMarginX, topPos + titleInputMarginY, titleInputWidth, titleInputHeight, (int) mouseX, (int) mouseY)) {
            context.setComponentTooltipForNextFrame(minecraft.font, Component.translatable("container.blockpalettes.editTitle").toFlatList(), mouseX, mouseY);
        }
